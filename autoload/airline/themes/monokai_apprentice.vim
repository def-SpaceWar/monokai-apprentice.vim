let s:N1 = [ '#212223' , '#98CEDE' , 232 , 154 ]
let s:N2 = [ '#EB3D54' , '#4A4B4C' , 222 , 238 ]
let s:N3 = [ '#8cffba' , '#242526' , 121 , 235 ]
let s:N4 = [ '#4A4B4C' , 241 ]

let s:I1 = [ '#212223' , '#63C485' , 232 , 39  ]
let s:I2 = [ '#EB3D54' , '#5AB8D9' , 222 , 27  ]
let s:I3 = [ '#63C485' , '#242321' , 39  , 235 ]

let s:V1 = [ '#212223' , '#C782EA' , 232 , 214 ]
let s:V2 = [ '#212223' , '#FFCE57' , 16  , 221 ]
let s:V3 = [ '#242526' , '#63C485' , 16  , 137 ]
let s:V4 = [ '#FFCE57' , 173 ]
